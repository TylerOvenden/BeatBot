...
public class MultiLineCustomText {
	...
	private int h;
	private String text;
	private ScrollablePane parentScreen;
	 ...
	 * @param screen
	 */
	public MultiLineCustomText(int xTopLeft, int yTopLeft, int width, int height, String s, ScrollablePane screen) {
		this.text = s;
	...
	public MultiLineCustomText(int xTopLeft, int yTopLeft, int width, int height, String s, ScrollablePane screen, int lengthOfLine) {
		this.text = s;
		this.x = xTopLeft; this.w = width;
		this.y = yTopLeft; this.h = height;
		customTextArr = new ArrayList<CustomText>();
